...
class com.continuityny.usoc.commands.SelectAthlete 
	implements Command {
...
*/
	...
	//	disable the start button on the ViewTools and enable the stop button
		USOC_Nav_View( MovieClipHelper.getMovieClipHelper( USOC_ViewList.VIEW_NAV ) ).selectAthlete(e);
	...
	public function toString() : String {
		return 'com.continuityny.usoc.commands.SelectAthlete' + HashCodeFactory.getKey( this );
	}
