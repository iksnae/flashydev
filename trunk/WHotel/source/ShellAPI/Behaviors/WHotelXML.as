package ShellAPI.Behaviors{
	...
	public class WHotelXML extends XMLBehaviorAbstract{

	private var __mainArray:Array;
	
    public function WHotelXML(targetURL:String){
    	trace("WHotelXML class instantiated with targetURL: " + targetURL);
